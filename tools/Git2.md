...
```bash
# 以 edbbba…… 树对象创建一个提交对象，同时提交信息为 `First Commit`
echo "First Commit" | git commit-tree edbbbaf17a0b477c133d457d4ec092af44bfed3a
# 得到的提交对象的 SHA 值
a3651086d55bcca52b1952a396e064a7d796713a
```

​	使用 `git cat-file` 查看该提交对象，可能会看到类似下面的场景：

<img src="https://s3.jpg.cm/2021/09/03/ItbHR4.png">
